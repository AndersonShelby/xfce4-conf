...
# Atualizando pacotes no Arch Linux
pacman -Syu --noconfirm
pacman -S --noconfirm wget xorg-xinit xfce4 xfce4-goodies breeze-icons ttf-cascadia-code audacious leafpad pavucontrol hexchat geany firefox

clear # Limpar terminal
printf "${info}${green}Bootstrap data...${reset}\n"
sleep 2
...
clear # Limpar terminal
printf "${info}${green}Setting up folders...${reset}\n"
mkdir $HOME/Desktop 
...
mv /usr/share/kvantum/* /usr/share/Kvantum 2>/dev/null || true
...
if [[ "$install_neofetch" == "y" ]]; then
    ...
    printf "${info}${green}Neofetch configuration applied!${reset}\n"
fi
